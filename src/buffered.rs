...
pub struct TlsConnection<'a, CipherSuite>
where
...
impl<'a, CipherSuite> TlsConnection<'a, CipherSuite>
where
    CipherSuite: TlsCipherSuite + 'static,
{
    ...
    pub fn new(read_buf: &'a mut [u8], write_buf: &'a mut [u8]) -> Self {
        Self {
            opened: false,
...
impl<'a, CipherSuite> Io for TlsConnection<'a, CipherSuite>
where
    CipherSuite: TlsCipherSuite + 'static,
{
    type Error = TlsError;
...
impl<'a, CipherSuite> Read for TlsConnection<'a, CipherSuite>
where
    CipherSuite: TlsCipherSuite + 'static,
{
...
impl<'a, CipherSuite> Write for TlsConnection<'a, CipherSuite>
where
    CipherSuite: TlsCipherSuite + 'static,
{
